...
class _HYStarRatingState extends State<HYStarRating> {
  ...
  List<Widget> buildUnselectedStar() {
    return List.generate((widget.count as int), (index) {
  ...
  List<Widget> buildSelectedStar() {
    ...
    // 2.构建满填充的star
    double oneValue = widget.maxRating! / (widget.count as int);
    ...
    double leftWidth = ((widget.rating! / oneValue) - entireCount) * (widget.size as double);
    ...
    if (stars.length >( widget.count as int)) {
